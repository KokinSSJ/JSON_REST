...
insert into Students(id, name, surname, course, address_id, phone_number, email) values (1, 'Dom', 'Bog', 'JAVA',1, 504, 'fdds@gma.com');
insert into Students(id, name, surname, course, address_id, phone_number, email) values (2, 'Dom2', 'Bog2', 'ENG',2,555555, 'dsadas@gma.com');
